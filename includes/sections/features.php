    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16 fade-in-up">
            ...
            <p class="text-white/70 text-lg max-w-2xl mx-auto">
                Discover the advanced capabilities that set WenKing Mod apart from the competition
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="glass-card p-8 rounded-xl hover-lift fade-in-up">
                <div class="flex items-center justify-center gap-3 mb-4">
                    ...
                    <h3 class="text-xl font-semibold mb-0">Advanced Security</h3>
                </div>
                <p class="text-white/60">Undetected with our advanced, industry-leading anti-cheat bypass technology</p>
            </div>
            ...
            <div class="glass-card p-8 rounded-xl hover-lift fade-in-up delay-100">
                <div class="flex items-center justify-center gap-3 mb-4">
                    ...
                    <h3 class="text-xl font-semibold mb-0">TEST</h3>
                </div>
                <p class="text-white/60">TEST</p>
            </div>
