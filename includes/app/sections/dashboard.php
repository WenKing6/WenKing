...
<!-- 统计卡片 -->
<div class="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-4 gap-6 mb-8">
    <!-- 订阅状态 -->
...
<div class="mb-8 p-6 rounded-xl" style="background-color: rgba(18, 18, 26, 0.6); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.1);">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-3 gap-4">
        ...
        <!-- GTA VI -->
        <div class="glass-card p-4 rounded-xl sm:last:col-span-2 2xl:last:col-span-1" style="background-color: rgba(255, 255, 255, 0.05);">
            <div class="flex items-center gap-4">
...
<div class="grid grid-cols-1 2xl:grid-cols-3 gap-6">
    <!-- 最近活动 -->
    <div class="glass-card p-6 rounded-xl 2xl:col-span-2">
