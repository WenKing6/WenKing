/**
 * GridScan 动画效果 - 原生 JavaScript 版本
 * 基于 Three.js 的网格扫描背景动画
 */
...
class GridScan {
    constructor(container, options = {}) {
        ...
        this.options = {
            ...
            linesColor: options.linesColor || '#2F293A',
            scanColor: options.scanColor || '#FF9FFC',
    ...
    animate() {
        ...
        // 平滑插值
        this.lookCurrent.x = this.smoothDamp(this.lookCurrent.x, this.lookTarget.x, this.lookVel.x, this.smoothTime, dt);
        this.lookCurrent.y = this.smoothDamp(this.lookCurrent.y, this.lookTarget.y, this.lookVel.y, this.smoothTime, dt);
        this.tiltCurrent = this.smoothDamp(this.tiltCurrent, this.tiltTarget, this.tiltVel, this.smoothTime, dt);
        this.yawCurrent = this.smoothDamp(this.yawCurrent, this.yawTarget, this.yawVel, this.smoothTime, dt);
    ...
    setColors(linesColor, scanColor) {
        if (this.material && this.material.uniforms) {
            this.material.uniforms.uLinesColor.value = this.srgbColor(linesColor);
            this.material.uniforms.uScanColor.value = this.srgbColor(scanColor);
        }
    }
