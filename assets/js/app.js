...
(function () {
    ...
    class PageLoader {
        ...
        _initAdminPage() {
            ...
            if (!window._adminDocEventsBound) {
                ...
                document.addEventListener('click', function(e) {
                    ...
                    // 经理领取钥匙（My Quota 卡片）已迁移至 license-module.js（.btn-claim-keys 委托）
            ...
            // 配额管理 / 领取钥匙弹窗：hash 路由注入片段后需重新初始化
            // （license-module.js 首次加载时页面可能尚未包含弹窗 DOM，initAll 为幂等设计可重复调用）
            if (window.LicenseModuleUI && typeof LicenseModuleUI.initAll === 'function') {
        ...
        // （配额管理 / 领取钥匙交互已迁移至 assets/js/license-module.js）
